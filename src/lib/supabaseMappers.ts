...
export function dbToCard(row: CardRow, cardBody?: CardBodyRow | null): Item {
  ...
  return {
    ...
    originalFileName: meta.originalFileName as string | undefined,
    fileSize: row.file_size ?? undefined,
    fileSizeBytes: meta.fileSizeBytes as number | undefined,
    ...
    fileSyncStatus: meta.fileSyncStatus as Item['fileSyncStatus'] | undefined,
    fileSyncError: meta.fileSyncError as string | undefined,
...
export function cardToDb(item: Item, userId: string): CardInsert {
  return {
    ...
    meta: {
      ...
      ...(typeof item.fileSizeBytes === 'number' ? { fileSizeBytes: item.fileSizeBytes } : {}),
      ...
      ...(item.fileSyncStatus ? { fileSyncStatus: item.fileSyncStatus } : {}),
      ...(item.fileSyncError ? { fileSyncError: item.fileSyncError } : {}),
